...
try {
    ...
    $required_fields = ['cuenta_id', 'activo_id', 'setfile_id', 'tipo', 'volumen', 'precio_entrada', 'precio_salida', 'ganancia', 'fecha_apertura', 'fecha_cierre', 'ticket'];
